...
def worker_argv(options: RunOptions) -> tuple[str, ...]:
    ...
    scalar_options = (
        ...
        ("response_low_water", options.response_low_water),
        ("response_high_water_segments", options.response_high_water_segments),
        ("response_low_water_segments", options.response_low_water_segments),
