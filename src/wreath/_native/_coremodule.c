...
static PyMethodDef core_methods[] = {
    ...
    {"prometheus_route_blocks", wreath_prometheus_route_blocks, METH_VARARGS,
     "prometheus_route_blocks(routes, names) -> four complete sample blocks"},
    ...
    {"geo_trajectory_compile", wreath_geo_trajectory_compile, METH_O,
     "geo_trajectory_compile(fixes) -> native trajectory"},
