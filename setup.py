...
_gzip_decoder_sources = [
    f"{_gzip_root}/decode/{name}.c" for name in ("cpu", "crc32", "inflate", "inflate_scalar")
]
...
if _gzip_x86_isa:
    _gzip_encoder_sources.extend(
        f"{_gzip_root}/encode/{name}.c" for name in ("crc32_pclmul", "crc32_vpclmul")
    )
...
ext_modules = [
    ...
    Extension(
        ...
        sources=[
            ...
            "src/wreath/_native/client_facts.c",
        ...
        depends=[
            ...
            "src/wreath/_native/ryu/ryu.h",
            "src/wreath/_native/ryu/common.h",
            "src/wreath/_native/ryu/digit_table.h",
            "src/wreath/_native/ryu/d2s_intrinsics.h",
            "src/wreath/_native/ryu/d2s_full_table.h",
            *_gzip_headers,
        ],
