...
def test_es256_roundtrip_and_tamper_against_oracle(n: int) -> None:
    ...
    verifier = JwtVerifier(algorithms=["ES256"], key=key_from_jwk(jwk), audience=None, required=())
...
def test_ed25519_roundtrip_and_tamper_against_oracle(n: int) -> None:
    ...
    verifier = JwtVerifier(algorithms=["EdDSA"], key=key_from_jwk(jwk), audience=None, required=())
