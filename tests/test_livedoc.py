...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"max_subscribers": True}, "expected a non-negative integer"),
        ({"max_subscribers": 1.5}, "expected a non-negative integer"),
        ({"max_subscribers": float("nan")}, "expected a non-negative integer"),
        ({"max_subscribers": float("inf")}, "expected a non-negative integer"),
        ({"max_per_principal": True}, "expected a non-negative integer"),
        ({"max_per_principal": 1.5}, "expected a non-negative integer"),
        ({"max_per_principal": float("nan")}, "expected a non-negative integer"),
        ({"max_per_principal": float("inf")}, "expected a non-negative integer"),
