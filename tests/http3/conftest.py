    ...
    * it loads fine, in which case this string is never shown.
    ...
    if importlib.util.find_spec("wreath._native._http3") is None:
        return (
            ...
            "WREATH_BUILD_HTTP3=1 with ngtcp2, nghttp3, and OpenSSL 3.5+"
        )
    try:
        ...
        return (
            ...
            "it on LD_LIBRARY_PATH rather than rebuilding"
        )
...
async def curl_http3(
    port: int, path: str, *extra: str, deadline: float = 12.0
) -> tuple[int, bytes]:
