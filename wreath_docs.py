...
nav = Nav(
    ...
    Section(
        ...
        Section(
            ...
            Page("Single sign-on", "guides/sso.md"),
    ...
    Section(
        ...
        Page("Tenancy", "reference/tenancy.md"),
        Page("SSO", "reference/sso.md"),
        Page("OAuth", "reference/oauth.md"),
        Page("Platform console", "reference/platform.md"),
    ...
    Section(
        ...
        Page("v0.3.3", "release_notes/0.3.3.md"),
