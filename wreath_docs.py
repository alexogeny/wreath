...
nav = Nav(
    ...
    Section(
        ...
        Page("Wreath 0.5.0", "release_notes/0.5.0.md"),
    ...
    Section(
        ...
        Page("Agents", "reference/agents.md"),
        Page("ChatOps", "reference/chat.md"),
        Page("Billing and subscriptions", "reference/billing.md"),
